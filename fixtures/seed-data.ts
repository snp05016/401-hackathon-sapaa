  ...
  },
{
    ...
    jobDescription: "Build the commerce platform that powers merchants, from checkout and payments to inventory, shipping, and storefront experiences.",
    status: "found",
    dateFound: daysAgo(3),
    dateApplied: null,
    deadline: inDays(0),
  ...
  },
  {
    ...
    jobDescription: "Build video infrastructure that delivers low-latency live streaming to creators and viewers around the world.",
    status: "found",
    dateFound: daysAgo(2),
    dateApplied: null,
    deadline: inDays(1),
